...
import jef.comparator.AppareilElectriqueComparator;
import jef.comparator.AppareilElectriqueComparatorParMarquePuisModelAscAvecHCB;
import jef.comparator.AppareilElectriqueComparatorParMarquePuisModelDescSansHCB;
import jef.comparator.AppareilElectriqueComparatorParModelAsc;
import jef.comparator.AppareilElectriqueComparatorParModelDesc;
import jef.comparator.AppareilElectriqueComparatorParPuissanceMaxDesc;
...
public class ComparatorTest {
	...
	public static void main(String[] args) {
		...
		triEtAfficheListe(LISTE_APPAREILS, new AppareilElectriqueComparatorParMarquePuisModelAscAvecHCB());
		triEtAfficheListe(LISTE_APPAREILS, new AppareilElectriqueComparatorParMarquePuisModelDescSansHCB());
		...
		// Comparator plus intelligent
		triEtAfficheListe(LISTE_APPAREILS, AppareilElectriqueComparator.PAR_MARQUE_ASC);
		triEtAfficheListe(LISTE_APPAREILS, AppareilElectriqueComparator.PAR_MARQUE_DESC);
		triEtAfficheListe(LISTE_APPAREILS, AppareilElectriqueComparator.PAR_MARQUE_ET_MODELE_ASC);
		triEtAfficheListe(LISTE_APPAREILS, AppareilElectriqueComparator.PAR_MARQUE_ET_MODELE_DESC);
	}
